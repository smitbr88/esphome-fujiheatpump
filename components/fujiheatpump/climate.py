...
FujiHeatPump = cg.global_ns.class_("FujiHeatPump", climate.Climate, cg.PollingComponent)
...
CONFIG_SCHEMA = climate.CLIMATE_SCHEMA.extend(
    {
        cv.GenerateID(): cv.declare_id(FujiHeatPump),
        cv.Optional(CONF_HARDWARE_UART, default="UART2"): valid_uart,
        cv.Optional(CONF_BAUD_RATE, default="500"): cv.positive_int,
